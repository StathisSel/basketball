...
<div class="container">
    ...
    <nav class="navbar navbar-expand-lg justify-content-between">
        ...
        <div class="row">
            <button class="btn btn-dark btn-lg"  type="button"  style="margin: auto; margin-right: 1px;" onclick="window.location.href = 'http://localhost:8002/?page=login';"  >Login</button>
        </div>
    </nav>
